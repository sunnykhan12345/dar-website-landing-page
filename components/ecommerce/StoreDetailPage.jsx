  ...
  return (
    <main className="bg-[#f6f6f6] rounded-tl-[12px] pb-20">
      <section className="container-dar pt-8">
        <div className="overflow-hidden rounded-t-[12px] bg-whit">
          ...
          <div className="relative flex flex-col gap-4 border-b bg-white/20 px-6 pb-5 pt-7 md:flex-row md:items-end">
            <img
              src={store.logo}
              alt={store.title}
            ...
            <div className="md:ml-[145px] -mt-4">
              <h1 className="text-2xl lg:text-4xl font-semibold">{store.title}</h1>

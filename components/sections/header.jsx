      ...
      <div className="container-dar flex h-[86px] items-center justify-between transition-all duration-500 md:h-[74px]">
        ...
        <div className="hidden items-center gap-5 xl:gap-8 lg:flex">
          <Link
            ...
            onClick={handleCartClick}
            className={cn(
              "group relative flex items-center gap-2.5 text-base font-medium transition-all duration-300 ease-out",
              pathname === "/cart"
                ? "text-[#f15a24]"
                : "text-[#151515] hover:text-[#f15a24]",
            )}
          >
            <span className="relative">
              ...
              {cartCount > 0 ? (
                <span className="absolute -right-2 -top-2 grid h-5 min-w-5 place-items-center rounded-full bg-[var(--orange)] px-1 text-[10px] font-bold text-white">
                  {cartCount}
                </span>
              ) : null}
            </span>
